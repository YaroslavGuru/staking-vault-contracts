...
/**
 * @title rYaroslav
 * @dev ERC20 reward token. Supports initial distribution and mintable by owner for funding rewards.
 */
contract rYaroslav is ERC20, Ownable {
    /**
    ...
    ) ERC20("Yaroslav Reward Token", "rYARO") Ownable(initialOwner) {
        require(recipients.length == amounts.length, "rYaroslav: arrays length mismatch");
